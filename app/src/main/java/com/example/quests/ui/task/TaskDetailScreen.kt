 ...
 *
 * Changes (from architecture sample's AddEditTaskScreen.kt):
 * - Pretty much everything, we don't use a floating action button for
 *   saving, we have fields for inputting due date and time, and the look
 *   was changed to be more similar to Tasks.org's task creation screen
 */
