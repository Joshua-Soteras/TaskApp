...
/**
 * Modified from https://issuetracker.google.com/issues/288311426#comment6
 */
    ...
    when (displayMode) {
        DisplayMode.Picker -> IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.switch_to_text_input),
            )
        }
        DisplayMode.Input -> IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.switch_to_touch_input),
            )
        }
    }
}
        ...
        Surface(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                CompositionLocalProvider(
                    ...
                    ProvideTextStyle(MaterialTheme.typography.labelLarge) {
                        // TODO: This should wrap on small screens, but we can't use
                        //  AlertDialogFlowRow as it is no public
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
